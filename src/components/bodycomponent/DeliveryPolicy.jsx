        ...
        <div className={`flex flex-col items-start justify-center w-full gap-y-4 ${margin}`}>
            ...
            <div className="flex justify-between items-center gap-x-3">
                <div className="flex justify-center items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="gray" class="bi bi-truck" viewBox="0 0 16 16">
                ...
                <div className="flex flex-col items-between justify-start">
                    <p className="text-black text-[12px] font-semibold">Delivery limit</p>
                    <p className="text-gray-500 text-[10px] font-semibold">Free delivery within 50 km’s.</p>
                </div>
            </div>

            <div className="flex justify-between items-center gap-x-3">
                <div className="flex justify-center items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="gray" class="bi bi-shield-slash" viewBox="0 0 16 16">
                ...
                <div className="flex flex-col items-between justify-start">
                    <p className="text-black text-[12px] font-semibold">Return Policy</p>
                    <p className="text-gray-500 text-[10px] font-semibold">With-in 5days of product delivery.</p>
                </div>
            </div>
